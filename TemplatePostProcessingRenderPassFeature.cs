...
public class TemplatePostProcessingRenderPassFeature : ScriptableRendererFeature
{
    ...
    {
        m_ScriptablePass.SetUp(renderer.cameraColorTarget, RenderTargetHandle.CameraTarget, materialLiberary);
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public void SetUp(RenderTargetIdentifier sourceTarget, RenderTargetHandle destination, MaterialLiberary materialLiberary)
        {
